...
public class GeoHelper {
	 ...
	 */
	public static GeoHelper fromDegrees(double latitude, double longitude) {
		GeoHelper result = new GeoHelper();
	 ...
	 */
	public static GeoHelper fromRadians(double latitude, double longitude) {
		GeoHelper result = new GeoHelper();
	 ...
	 * argument.
	 */
	public double distanceTo(GeoHelper location, double radius) {
	 ...
	 * </ul>
	 */
	public GeoHelper[] boundingCoordinates(double distance, double radius) {
		...
		return new GeoHelper[]{fromRadians(minLat, minLon),
